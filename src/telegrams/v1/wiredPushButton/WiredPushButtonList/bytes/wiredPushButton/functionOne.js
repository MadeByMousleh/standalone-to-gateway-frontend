...
export default class FunctionOne {
    ...
    getFunctionInformation(bit) {
        return GeneralHelper.wiredButtonFunctions[bit]
    }


    getActiveFunction() {
        return GeneralHelper.wiredButtonFunctions[this.byte];
    }
